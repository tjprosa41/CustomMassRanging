...
namespace CustomMassRanging
{
    public partial class Parameters : ObservableObject
    {
        ...
        [ObservableProperty]
        [field: Display(Name = "Ranges were Updated", AutoGenerateField = false, GroupName = "Updated")]
        public bool rangesUpdated;

        [ObservableProperty]
        [field: Display(Name = "Multis were Updated", AutoGenerateField = false, GroupName = "Updated")]
        public bool multisUpdated;
        ...
        public void ResetParametersObservablesToPropertiesObservables(CustomMassRangingProperties properties)
        {
            ...
            RangesUpdated = properties.RangesUpdated;
            MultisUpdated = properties.MultisUpdated;
